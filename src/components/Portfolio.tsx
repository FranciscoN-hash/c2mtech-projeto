      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {projectsData.map((project) => (
            <div key={project.id} className="bg-white/5 rounded-xl overflow-hidden border border-white/10 p-5 flex flex-col justify-between">
              <div>
                <img src={project.mockupUrl} alt={project.title} className="w-full h-48 object-cover rounded-lg mb-4" />
